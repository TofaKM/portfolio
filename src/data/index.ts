...
export const projects: Project[] = [
  ...
  {
    id: '3',
    title: 'Telecom Churn Classification Pipeline',
    description: 'In-progress Apache Spark project splitting a customer churn dataset into fact/dimension tables for a data engineering + data science workflow.',
    longDescription: 'Currently building a data engineering workflow around a telecom customer-churn classification dataset — customer demographics, subscription/plan attributes, usage metrics, billing, support-interaction history, and payment behaviour, with churn as the target label. The work in progress: modelling the raw data into a star schema (a customer/plan/region dimension layer plus a fact table capturing usage, billing, and churn outcome), and processing it with Apache Spark. Apache Airflow orchestration is planned next, with the eventual goal of extending this into a full data science project on top of the resulting table structure. Not yet published — this one is still under active development.',
    tech: ['Apache Spark', 'Python', 'Data Modeling'],
    featured: false,
    category: 'data',
    year: '2026',
    status: 'in-progress',
